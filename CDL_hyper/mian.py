...
def optimizer(args):
    ...
    with tf.Session() as sess:
        if model_name == "CDL":
            ...
            model = CDL(sess,hyper,num_users, num_items, num_voca, hidden_neuron,current_time,
        ...
        Cost,RMSE, MAE, ACC, AVG_loglikelihood,recall_M=model.run()
    return {
            'status': STATUS_OK,
            'loss': Cost,
...
def main():
    ...
    t = Trials()
    best = fmin(optimizer, space, algo=tpe.suggest, max_evals=4, trials=t)
...
if __name__ == '__main__':
    ...
    corruption_level = args.corruption_level #0.3
    ...
    #result_path="./results/politic_new/CDL/1/current_time"
